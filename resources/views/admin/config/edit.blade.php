            ...
            <table class="add_tab">
                <tbody>
                    ...
                    <tr class="field_value">
                        ...
                        <td>
                            <input class="lg" type="text" name="field_value" value="{{$field->field_value}}">
                            <p><i class="fa fa-exclamation-circle yellow"></i>類型值只有radio的情況下才需要配置，格式 1|開啟,0|關閉</p>
                        </td>
                    </tr>
                    <tr>
